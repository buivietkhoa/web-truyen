...
interface CompletedStoriesCarouselProps {
  stories: CompletedStory[];
}

export default function CompletedStoriesCarousel({
  stories,
}: CompletedStoriesCarouselProps) {
  ...
  const renderStory = (story: CompletedStory, duplicate = false) => (
    <div
      className={`completed-carousel-slide${duplicate ? " completed-carousel-copy" : ""}`}
    ...
    >
      ...
      >
        <img
          ...
          className="completed-item-cover"
        />
  ...
  return (
    <div
      ...
      onMouseLeave={resume}
    >
      <div className="completed-carousel-track">
