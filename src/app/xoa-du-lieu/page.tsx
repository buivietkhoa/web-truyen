  ...
  return (
    <>
      ...
      <main className="container" style={{ maxWidth: 800, padding: "2rem 1rem" }}>
        ...
        <p>
          Nếu bạn muốn xóa toàn bộ dữ liệu cá nhân khỏi hệ thống của chúng tôi, hãy thực
        ...
        <p>
          Sau khi xóa, toàn bộ thông tin cá nhân, lịch sử đọc và danh sách yêu thích của bạn
          sẽ bị xóa vĩnh viễn khỏi hệ thống.
        </p>

        <h2>Cách 2: Yêu cầu thủ công</h2>
        <p>
          Nếu bạn không thể đăng nhập, hãy gửi email với tiêu đề <strong>"Yêu cầu xóa dữ liệu"</strong>{" "}
          kèm địa chỉ email đã đăng ký. Chúng tôi sẽ xử lý trong vòng 7 ngày làm việc.
        </p>
        ...
        <ul>
          ...
          <li>Toàn bộ liên kết với tài khoản Facebook/Google</li>
        </ul>
      </main>
      <SiteFooter />
    </>
